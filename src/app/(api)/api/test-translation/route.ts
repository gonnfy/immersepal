...
const testTranslationSchema = z.object({
  ...
  sourceLanguage: z.string().min(2, 'Source language must be provided (e.g., "en" or "English").'),
  targetLanguage: z.string().min(2, 'Target language must be provided (e.g., "ja" or "Japanese").'),
});
